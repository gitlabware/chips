<section role="main" id="main">
    ...
    <hgroup id="main-title" class="thin">
        <h1>Distribuicion Celulares mediante Excel </h1>
    </hgroup>
    <div class="with-padding">        
        ...
        <div id="muestraFormAsignaciones">
            <?php echo $this->Form->create('Almacene', array('action' => 'guardaexcel_cel', 'id' => 'formAsig', 'enctype' => 'multipart/form-data')); ?>
            ...
            <div class="new-row twelve-columns">                
                ...
                <fieldset class="fieldset fields-list">
                    ...
                    <div class="field-block button-height">
                        ...
                        <a href="<?= $this->webroot; ?>formatos/distribucion-cel.xlsx" class="button"><span class="button-icon"><span class="icon-download"></span></span> Formato</a>
                    </div>                                        
        ...
        <script>
          ...
          function openModal()
          {
              ...
              $.modal({
                  ...
                  content: '<?php echo $this->Html->image('iconos/formato-distribucion-cel.png'); ?>',
                          center: true,
                  width: 700,
                  height: 250,
              });
        ...
        <div id="muestraFormActivaciones" style="display: none;">
            <?php echo $this->Form->create('Almacene', array('action' => 'guardaexcelcomp_cel', 'id' => 'formActi', 'enctype' => 'multipart/form-data')); ?>
            <!--        <form method="post" action="" class="columns" onsubmit="return false">                               -->
            <!--<div class="new-row-desktop four-columns six-columns-tablet twelve-columns-mobile">-->
            <div class="new-row twelve-columns">                
                <!--                <h3 class="thin underline">&nbsp;</h3>                                          -->
