        ...
        <div class="columns">
            <div class="six-columns twelve-columns-mobile">
              <p class="block-label button-height">
                ...
                <?php echo $this->Form->text("Movimientospremio.ingreso",array('class' => 'input full-width','placeholder' => 'Nombre del premio'));?>
              </p>
            </div>
            <div class="six-columns twelve-columns-mobile">
              <p class="block-label button-height">
        ...
        <table class="simple-table responsive-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                      <?php echo $this->Html->link("Quitar",array('action' => 'movimientospremios'));?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
