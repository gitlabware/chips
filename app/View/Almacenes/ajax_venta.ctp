...
<div class="twelve-columns" id="mod-normal">
    <?php echo $this->Form->create('Venstasdistribuidor', array('class' => 'columns', 'id' => 'form-reg', 'url' => array('controller' => 'Ventasdistribuidor', 'action' => 'registra_venta_mayor_ajax', $persona))) ?>
    <fieldset class="fieldset">
        ...
        <?php foreach ($precios as $key => $pre): ?>
          ...
          <?php echo $this->Form->hidden("Movimiento.$key.created", array('value' => $fecha_ini)); ?>
        <?php endforeach; ?>
