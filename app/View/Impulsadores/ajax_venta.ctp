<h3 id="tit-entregas">
    Fomulario de entregas <?php echo $fecha ?>
</h3>

<div class="twelve-columns" id="mod-normal">
    <?php echo $this->Form->create('Venstasimpulsadore', array('class' => 'columns', 'id' => 'form-reg', 'url' => array('controller' => 'Ventasdistribuidor', 'action' => 'registra_venta_mayor_ajax', $persona))) ?>
    <fieldset class="fieldset">
        ...
        <?php foreach ($precios as $key => $pre): ?>
          ...
          <?php echo $this->Form->hidden("Movimiento.$key.user_id", array('value' => $idUser)); ?>
          ...
          <?php echo $this->Form->hidden("Movimiento.$key.created", array('value' => $fecha)); ?>
          <?php echo $this->Form->hidden("Movimiento.$key.minievento_id", array('value' => $idMiniEvento)); ?>
        <?php endforeach; ?>
