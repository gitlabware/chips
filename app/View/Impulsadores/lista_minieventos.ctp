            ...
            <tbody>
                <?php foreach ($minieventos as $mi): ?>
                  <tr>
                      ...
                      <td>
                          <?php echo $this->Html->link('Ingresar',array('action' => 'ventas_minievento',$mi['Minievento']['id']),array('class' => 'button blue-gradient glossy'));?>
...
<?php
echo $this->element('sidebar/impulsador');
?>