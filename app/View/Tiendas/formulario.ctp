        ...
        <div class="grid-4">
            ...
            <div class="content-gird">
                <div id="imprimir">
                    ...
                    <?php echo $this->Form->create(null, array('url' => array('controller' => 'Tiendas', 'action' => 'registra_venta_mayor',$idAlmacen), 'id' => 'formID')); ?>
                    <?php
                    if (!empty($num_trans)) {
                                  ...
                                  <table class="mitabla2" style="width:100%;">
                                      ...
                                      <tr>
                                          <td align="center" style="color: teal; font-weight: bold;">
                                              <?php echo $this->requestAction(array('action' => 'get_total', $r['Producto']['id'], 1, $idAlmacen)) ?>
                                          </td>
                                      </tr>
                                  </table>
                              </td>
