...
<div id="main" class="contenedor">
    ...
    <hgroup id="main-title" class="thin">
        <h1>LISTADO DE SIM'S SIN ASIGNAR <small>(<?php echo $excel['Excel']['nombre_original']?>)</small></h1>
    </hgroup>
...
<script>
  //urljsontabla = '<?php echo $this->Html->url(array('action' => 'asigna_distrib_exc.json')); ?>';
</script>
